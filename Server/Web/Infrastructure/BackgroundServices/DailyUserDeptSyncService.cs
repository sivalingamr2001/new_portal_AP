...
public class DailyUserDeptSyncService(IServiceProvider serviceProvider, ILogger<DailyUserDeptSyncService> logger)
    : BackgroundService, IDailyUserDeptSyncService
{
    ...
    private async Task ExecuteSyncAsync(CancellationToken stoppingToken)
    {
        ...
        var isTestEnv = db.Database.IsSqlite();
