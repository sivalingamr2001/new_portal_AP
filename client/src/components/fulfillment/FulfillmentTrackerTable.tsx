        ...
        <div className="w-full overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="divide-y divide-slate-100">
                {headers.length === 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center bg-white py-12 px-4 text-center">
                        {/* Functional Visual Anchor */}
                        <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-slate-50 text-slate-400 text-xl">
                            📦
                        </div>
                        <h3 className="text-sm font-semibold text-slate-900">No allocations found</h3>
                        <p className="mt-1 text-xs text-slate-500 max-w-xs mx-auto">
                            There are currently no records available in this time period.
                        </p>
                    </div>
                ) : (
                    /* Existing Headers Loop */
                    headers.map((h) => {
